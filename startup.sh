...
db_user = os.environ.get('PGUSER', 'lebeadmin')
db_password = os.environ.get('PGPASSWORD', 'lebe098')
db_host = os.environ.get('PGHOST', 'db')
db_port = os.environ.get('PGPORT', '5432')
db_name = os.environ.get('PGDATABASE', 'lebe')
...
echo "Starting Lebe application..."
exec gunicorn \
	--bind 0.0.0.0:8000 \
	--workers 4 \
